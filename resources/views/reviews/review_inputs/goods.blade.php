    ...
    <div class="d-flex reviews-heading align-items-center flex-grow-1 flex-wrap  flex-lg-nowrap">
        ...
        <div class="col-sm-3">
            <select class="select required"
                    ...
                    disabled
                    required>
                <option disabled selected value="{{ empty($review) ? '' : $review->category_group->id }}">
                    {{ empty($review) ? \App\Services\DataService::getTranslate('service/index.select.country') : $review->category_group->name }}
                </option>
